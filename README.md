...
https://naprincee.shinyapps.io/CollegeDataApp/
...
The following code makes a dashboard page with a sidebar having four menus - 'Introduction', 'Dataset', 'Summary' and 'Visualization' and some user input options to filter some characteristics of the institutions. 
...
This is the backend side of the app where all the calculations and constructions of graphs are made.
